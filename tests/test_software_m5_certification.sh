...
for candidate in mutations:
    try:
        ...
        raise AssertionError("weakened policy mutation unexpectedly passed")
...
echo "[PASS] production-qualified Software M5 certifier passes real evidence and rejects floor weakening"
