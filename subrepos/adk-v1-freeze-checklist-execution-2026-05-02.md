...
- 基线模板：`subrepos/adk-v1-freeze-checklist.md`
...
- [x] adk 全量测试通过
  ...
  - 结果：`All tests passed`
- [x] 压实总门禁通过（含技能/路由/文档）
  - 验证命令：`rtk scripts/check-adk-harden-readiness.sh . --require-pilot`
  - 结果：`[PASS] adk full regression suite passed`
...
- [x] Breaking Change 已给出迁移与回滚步骤
  - 证据：`reports/adk-v1-migration-rollback-plan-2026-05-02.md`
- [x] 回滚演练命令可执行且结果已记录
  - 证据：`reports/adk-v1-migration-rollback-plan-2026-05-02.md`（2026-05-02 09:52:51 CST 演练记录）
...
- 报告文件路径：
  ...
  - `reports/adk-v1-migration-rollback-plan-2026-05-02.md`
  - `reports/adk-v1-freeze-signoff-2026-05-02.md`
  - `subrepos/adoption-matrix.md`
  - `subrepos/adk-v1-harden-blueprint.md`
