...
- projection_inputs_sha256: 28d2b691d1134883355d18d9411ea49fabe7b3f190e46a0a8264088d32e0e662
- current_adk_version: 5.0.0-rc.2
- current_adk_commit: 78d479339bac7c8aefb123c3101f33c209a076d4
- current_adk_tree: 6ca2eef983b4aa1a9a8f71c3a1bcf7301ce88d05
...
当前源投影只绑定非自引用 SSOT 输入：`adk.lock`、gate manifest、maturity scorecard、Software M5 policy 与 projection 实现本身。它证明当前 source pin/机器状态是否同步，不把历史 runtime/release/field 证据自动升级到新 ADK commit。当前 ADK 已前进到 `78d47933…`，而正式 release evidence 仍绑定 `12bfeaf1…`，因此明确标记为 `historical` 且 `release_authorized=false`。
