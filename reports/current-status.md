...
- projection_inputs_sha256: 27ae2d3ab0d62702397c59d29e170039cc9e7ee025bfb2efe8e56b3cf1e78905
- current_adk_version: 5.0.0-rc.2
- current_adk_commit: e99834833d6d5495ff1adc2dfafe8f6aa825f8a9
- current_adk_tree: 50423568f82db91b3f92a087842dcd2bbd531d94
- current_adk_manifest_blob: 823ee268e16116b1ec56aa9033c41c49efb11bd0
- current_product_maturity: M3
- current_software_m5_readiness: not-ready
- current_software_m5_certified: false
- current_terminal_mature: false
- current_field_status: self_pilot_active
- release_candidate_version: 5.0.0-rc.2
- release_candidate_commit: 12bfeaf1f85b297628b57ac15d12eedc849e3919
- release_evidence_relation: historical
- release_authorized: false
<!-- END GENERATED CURRENT SOURCE PROJECTION -->

当前源投影只绑定非自引用 SSOT 输入：`adk.lock`、gate manifest、maturity scorecard、Software M5 policy 与 projection 实现本身。它证明当前 source pin/机器状态是否同步，不把历史 runtime/release/field 证据自动升级到新 ADK commit。当前 source identity、historical release relation 与 release authorization 以 generated block 为唯一机器可读投影，正文不再复制 current ADK SHA。

## Last Verified Product Baseline (Historical Evidence)
